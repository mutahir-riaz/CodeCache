...
function AllCategories(props) {
  return (
    <div>
      <div className="flex ml-[26%] mt-10">
        <p className='text-2xl pt-3'>{props.id}</p>
        <img src={pic} alt="" className='w-20 ml-8 mr-8 h-20 rounded-[50%]  outline-none' />
        <p className='text-2xl pt-3'>{props.category}</p>
